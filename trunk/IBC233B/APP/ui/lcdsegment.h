...
#define PAUS_ICON_MASK	0x0080
#define F_PAUS_DEV		(lcd_buff[1])	
...
#define PROG_ICON_MASK		0x0080
#define F_PROG_ICON_BUF	(lcd_buff[2])	

#define MEM_ICON_MASK		0x0020
#define F_MEM_ICON_BUF		(lcd_buff[4])	
