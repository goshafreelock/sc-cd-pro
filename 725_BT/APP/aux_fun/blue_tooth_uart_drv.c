...
void blue_tooth_mode_end_handler(void)
{
...
{
#if 0//def BT_DEV_NAME_Tabeoke
	0xAA ,0x00 ,0x08 ,0x05 ,0x54 ,0x61 ,0x62 ,0x65 ,0x6F ,0x6B ,0x65,0x38,
#else

#ifdef NEW_CD_GS_3012BT_V001
	0xAA ,0x00 ,0x08 ,0x05 ,0x47 ,0x53 ,0x2D ,0x33 ,0x30 ,0x31 ,0x32,0x66,		//GS-3012
#else
	//0xAA ,0x00 ,0x06 ,0x05 ,0x37 ,0x32 ,0x35 ,0x42 ,0x54,0xC1, 				// 725BT
	//0xAA ,0x00 ,0x0A ,0x05 ,0x50 ,0x43 ,0x44 ,0x2D ,0x33 ,0x31 ,0x38 ,0x42 ,0x54 ,0xBB,		//PCD-318BT
	0xAA ,0x00 ,0x08 ,0x05 ,0x53 ,0x43 ,0x44 ,0x33 ,0x38 ,0x30 ,0x30 ,0x4E,			//SCD3800
#endif
...
u8 bluetooth_cmd_parse(void)
{
	...
	UTCON = 0x01;
#if 0/// mute shut down this trace ,,or else iphone connection fail
	sys_printf("   ");
	for(j=0;j<7;j++)
		printf("-->cmd_key %x \r\n",(u16)rev_cmd[j]);
#endif
